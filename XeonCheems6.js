...
reply(`Saya adalah ShanBots, Bot WhatsApp yang siap membantu anda, Saya bisa membuat stiker, mendownload video dan lagu di youtube, Dll, Ketik *Menu* untuk melihat fitur yang lebih banyak!`)
            ...
            break
case 'tes': case 'test': case 'tesss': {
reply(`*BOT AKTIF KAK*`)
}
            break
case 'tolol': case 'anjing': case 'goblok': case 'jancok': case 'anjir': case 'asu': case 'njir': case 'anjay': {
...
case 'pcbut':
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                    if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcbut 62xxxxxxxxxx`)
                 buttonvirus = [
...
case 'pcstick':{
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcstick 62xxxxxxxxxx`)
xeonOP = { 
        key: { 
            fromMe: false, 
            participant: `0@s.whatsapp.net`, 
...
case 'pcvn':{
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcvn 62xxxxxxxxxx`)
xeonvn = { 
        key: { 
            fromMe: false, 
            participant: `0@s.whatsapp.net`, 
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcinfinite 62xxxxxxxxxx`)
            ...
            break
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!m.isGroup) return m.reply(mess.group)
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcinfinite 62xxxxxxxxxx`)
             pcgcinfinitexeon = { 
                    key: { 
                        fromMe: false, 
                        participant: `0@s.whatsapp.net`, 
...
`
          ...
          case 'pcbunny': { 
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcbunny 62xxxxxxxxxx`)
             rabbitxeon = `
///....▓▓▓▓
///..▓▓......▓
///..▓▓......▓▓..................▓▓▓▓
...
`
            ...
            break 
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!m.isGroup) return m.reply(mess.group)
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcbunny 62xxxxxxxxxx`)
             bunnypcgcx = `
///....▓▓▓▓
///..▓▓......▓
///..▓▓......▓▓..................▓▓▓▓
 ...
 break
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "All Menu ( Menu Berantakan ) 🥀",
