...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nBalasan otomatis telah diaktifkan di grup ini, artinya bot dapat mengirim catatan suara yang tidak perlu!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
case 'patricksticker':
m.reply(mess.wait)
XeonBotInc.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/patrick?apikey=dhmDlD5x`}}, {quoted: m, packname: global.packname, author: global.author, })})
break
case 'ttp': {
